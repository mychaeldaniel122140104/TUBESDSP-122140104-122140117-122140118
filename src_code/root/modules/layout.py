...
def init_layout(app):
    ...
    title = tk.Label(
        app.window,
        text="Realtime rPPG and Respiration Rate Tracker",
    ...
    start_btn = tk.Button(
        button_frame,
        text="▶ START",
        command=lambda: start_video(app),
        bg="lime green",
        fg="white",
        font=("Arial", 12, "bold"),
        width=12
    ...
    # Tombol: Rekam 30 Detik
    record_btn = tk.Button(
        button_frame,
        text="📊 RECORD 30s",
        command=lambda: start_30s_recording(app),
        bg="orange",
        fg="white",
        font=("Arial", 12, "bold"),
        width=15
